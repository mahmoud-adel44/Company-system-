...
<body>
  ...
  <header>
    <nav>
      ...
      <?php } ?>
      <ul id="navli">
        <li><a class="homered" href="myTasksphp?emId=<?php echo $empId ?>">My tasks</a></li>
        <li><a class="homeblack" href="chat.php?emId=<?php echo $empId ?>">chat</a></li>
